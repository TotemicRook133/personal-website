    ...
    document.querySelectorAll('.box').forEach(image => {
        ...
        if (image.innerText.length !== 0) {
            if (image.innerText == 'Wpawn' || image.innerText == 'Bpawn') {
                image.innerHTML = `${image.innerText} <img class='allimg allpawn' src="images/chess/${image.innerText}.png" alt="">`
                ...
                image.innerHTML = `${image.innerText} <img class='allimg' src="images/chess/${image.innerText}.png" alt="">`
                image.style.cursor = 'pointer'
            }
        }
    })
...
function coloring() {
    ...
    color.forEach(color => {
        ...
        if (a % 2 == 0) {
            color.style.backgroundColor = 'rgb(233, 237, 204)'
        }
        if (a % 2 !== 0) {
            color.style.backgroundColor = 'rgb(119, 153, 84)'
        }
        // if (a % 2 == 0) {
